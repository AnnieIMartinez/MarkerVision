...
cam.Resolution = cam.AvailableResolutions{1};   %Resolution 1920x1080

%Camera for good video
cam2nd = webcam(2);
cam2nd.Resolution = cam2nd.AvailableResolutions{1}; %Resolution 1920x1080

% Object for writing video
vwrite = VideoWriter('Purple_12(00)_6','MPEG-4');
vwrite_2ndcam = VideoWriter('Purple_12(00)_6_real','MPEG-4');
